...
def simulate_tomatoes(sma_window, margin):
    ...
    # CONSERVATIVE FILL: Only if the opposite side crosses our resting order
    bid_eaten = (next_ask <= our_bids)
    ask_eaten = (next_bid >= our_asks)
...
print("Optimizing TOMATOES (Conservative Fills)...")
for sma in range(10, 80, 5):
    for m in range(0, 5):
...
print("Optimizing EMERALDS (Conservative Fills)...")
best_e_margin = None
